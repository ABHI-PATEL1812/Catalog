...
from .views import AuthorAPI, CreateBookCatalogAPI, CategoryAPI, GetMostBookSoldByAuthorAPI, GetMostBookSoldByCategoryAPI, SearchBookAPI, GetBooksByAuthorAPI
